...
namespace muli.Properties {
    ...
    public partial class DataDataSet : global::System.Data.DataSet {
        ...
        public partial class TableDataTable : global::System.Data.TypedTableBase<TableRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public TableRow AddTableRow(string username, string password, string kind, string work, string lastname, int phonenumber) {
        ...
        public partial class TableRow : global::System.Data.DataRow {
            ...
            public string kind {
                get {
                    try {
                        return ((string)(this[this.tableTable.kindColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("The value for column \'kind\' in table \'Table\' is DBNull.", e);
                    }
                }
                set {
                    this[this.tableTable.kindColumn] = value;
                }
            }
            ...
            public bool IskindNull() {
                return this.IsNull(this.tableTable.kindColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public void SetkindNull() {
                this[this.tableTable.kindColumn] = global::System.Convert.DBNull;
            }
...
namespace muli.Properties.DataDataSetTableAdapters {
    ...
    public partial class TableTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Table] ([username], [password], [kind], [work], [lastname], [phonenumber]) VALUES (@username, @password, @kind, @work, @lastname, @phonenumber);
SELECT username, password, kind, work, lastname, phonenumber FROM [Table] WHERE (username = @username)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Table] SET [username] = @username, [password] = @password, [kind] = @kind, [work] = @work, [lastname] = @lastname, [phonenumber] = @phonenumber WHERE (([username] = @Original_username) AND ((@IsNull_password = 1 AND [password] IS NULL) OR ([password] = @Original_password)) AND ((@IsNull_kind = 1 AND [kind] IS NULL) OR ([kind] = @Original_kind)) AND ((@IsNull_work = 1 AND [work] IS NULL) OR ([work] = @Original_work)) AND ((@IsNull_lastname = 1 AND [lastname] IS NULL) OR ([lastname] = @Original_lastname)) AND ((@IsNull_phonenumber = 1 AND [phonenumber] IS NULL) OR ([phonenumber] = @Original_phonenumber)));
SELECT username, password, kind, work, lastname, phonenumber FROM [Table] WHERE (username = @username)";
        ...
        private void InitConnection() {
           ...
           // this._connection.ConnectionString = global::muli.Properties.Settings.Default.DataConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT username, password, kind, [work], lastname, phonenumber FROM dbo.[Table]";
        ...
        public virtual int Delete(string Original_username, string Original_password, string Original_kind, string Original_work, string Original_lastname, global::System.Nullable<int> Original_phonenumber) {
        ...
        public virtual int Insert(string username, string password, string kind, string work, string lastname, global::System.Nullable<int> phonenumber) {
            if ((username == null)) {
        ...
        public virtual int Update(string username, string password, string kind, string work, string lastname, global::System.Nullable<int> phonenumber, string Original_username, string Original_password, string Original_kind, string Original_work, string Original_lastname, global::System.Nullable<int> Original_phonenumber) {
            if ((username == null)) {
                throw new global::System.ArgumentNullException("username");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string password, string kind, string work, string lastname, global::System.Nullable<int> phonenumber, string Original_username, string Original_password, string Original_kind, string Original_work, string Original_lastname, global::System.Nullable<int> Original_phonenumber) {
            return this.Update(Original_username, password, kind, work, lastname, phonenumber, Original_username, Original_password, Original_kind, Original_work, Original_lastname, Original_phonenumber);
        }
    }
